(() => {
  // ns-hugo:/media/jeonjongyook/전종욱/jongwook`s-Devblog/assets/ts/gallery.ts
  ...
  // ns-hugo:/media/jeonjongyook/전종욱/jongwook`s-Devblog/assets/ts/color.ts
  var colorsCache = {};
  ...
  // ns-hugo:/media/jeonjongyook/전종욱/jongwook`s-Devblog/assets/ts/menu.ts
  ...
  // ns-hugo:/media/jeonjongyook/전종욱/jongwook`s-Devblog/assets/ts/createElement.ts
  ...
  // ns-hugo:/media/jeonjongyook/전종욱/jongwook`s-Devblog/assets/ts/colorScheme.ts
  ...
  // ns-hugo:/media/jeonjongyook/전종욱/jongwook`s-Devblog/assets/ts/scrollspy.ts
  ...
  // ns-hugo:/media/jeonjongyook/전종욱/jongwook`s-Devblog/assets/ts/smoothAnchors.ts
  ...
  function setupSmoothAnchors() {
    document.querySelectorAll(anchorLinksQuery).forEach((aElement) => {
      ...
      aElement.addEventListener("click", (clickEvent) => {
        ...
        let target = document.getElementById(targetId.replace(":", "\\:"));
